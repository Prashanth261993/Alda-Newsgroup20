...
perceptron_train_pred = perceptron_fit.predict(docs_train.data)

#Save predicted outputs to be used as input for Hybrid NN
np.savetxt('mlp_train_predict.txt', perceptron_train_pred, delimiter=',')
np.savetxt('mlp_test_predict.txt', perceptron_pred, delimiter=',')
...
svm_train_predict = pipeline_svm_fitted.predict(docs_train.data)

#Save predicted outputs to be used as input for Hybrid NN
np.savetxt('svm_train_predict.txt', svm_train_predict, delimiter=',')
np.savetxt('svm_test_predict.txt', svm_predict, delimiter=',')